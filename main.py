...
PF1_obj.fill_y()
PF1_obj.flat_start()
PF1_obj.set_tolerance(0.0001)
PF1_obj.Newton_Raphson()
PF1_obj.output_voltages()
PF1_obj.calculate_current_flow()
PF1_obj.calculate_losses()
PF1_obj.flow_of_power()
PF1_obj.slack_pv_calculations()
print(PF1_obj.total_losses)
